...
- Abrir un issue o un PR con cambios.
- Para cambios funcionales, incluir pruebas que reproduzcan el comportamiento esperado.
- El agente de revisión automático está disponible en la raíz como `.agent.md`.
